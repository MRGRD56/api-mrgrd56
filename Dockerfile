...
RUN apk update
RUN apk add -X https://dl-cdn.alpinelinux.org/alpine/v3.17/main gcompat
...
RUN apk add -X https://dl-cdn.alpinelinux.org/alpine/v3.17/community -X https://dl-cdn.alpinelinux.org/alpine/v3.17/main tesseract-ocr-data-eng=5.2.0-r1 tesseract-ocr-data-rus=5.2.0-r1 tesseract-ocr-data-jpn=5.2.0-r1 tesseract-ocr-data-chi_sim=5.2.0-r1 tesseract-ocr-data-chi_tra=5.2.0-r1 tesseract-ocr-data-spa=5.2.0-r1 tesseract-ocr-data-hin=5.2.0-r1 tesseract-ocr-data-ben=5.2.0-r1 tesseract-ocr-data-por=5.2.0-r1 tesseract-ocr-data-vie tesseract-ocr-data-deu=5.2.0-r1 tesseract-ocr-data-fra=5.2.0-r1 tesseract-ocr-data-ita=5.2.0-r1 tesseract-ocr-data-bel=5.2.0-r1 tesseract-ocr-data-ukr=5.2.0-r1
